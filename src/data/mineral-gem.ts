// Données de la page vitrine « Mineral & Gem » — mise à jour annuelle = éditer
  ...
  zones: [
    {
      cle: "mineral",
      nom: "Zone Mineral",
      desc: "Minéraux, fossiles, météorites, lithothérapie, cristallographie, micro-minéralogie, presse spécialisée, exposition prestige.",
    },
    {
      cle: "gem",
      nom: "Zone Gem",
      desc: "Pierres brutes et taillées, joaillerie, gemmologie, perles, nacre, colliers.",
    },
  ],
  programme: [
