...
export const demarchesRapides: Tile[] = [
  ...
  { label: "Signalement", desc: "Voirie, éclairage…", href: "/contact/", icon: '<path d="M12 9v4M12 17h.01M10.3 3.9 2 18a2 2 0 0 0 1.7 3h16.6a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0z"/>' },
